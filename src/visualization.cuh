...
void plotVectorField(const float* d_u, const float* d_v, const float* d_w, const float* d_weights, const size_t sliceZval, const std::string sFileU, const std::string sFileV, const std::string sFileW, const std::string sFileWeights, const std::string sPlotName, const size_t width, const size_t height, const size_t depth);
